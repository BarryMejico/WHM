<template>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                ...
                <div align="center">  
                         <img src="../media/bs3.png" alt="logo" style="width:60%;">
                </div>
                <br>
                <br>
                <br>
                ...
                <div>
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<j class="lead text-muted">A group of freelance web developers innovating web services to give Filipino entrepreneurs a modern tool for their businesses.</j>
                  <hr><br>
                   <h4 class="text-muted"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We Offer:</h4>
                   <br>
                   <br>
                   <br>
